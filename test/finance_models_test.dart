...
void main() {
  ...
  test('calculates household monthly totals in cents', () {
    final entries = [
      TransactionEntry(id: 1, type: EntryType.income, description: 'Salário', amountCents: 300000, date: DateTime(2026, 9, 1)),
      TransactionEntry(id: 2, type: EntryType.expense, description: 'Aluguel', amountCents: 140000, date: DateTime(2026, 9, 5)),
      TransactionEntry(id: 3, type: EntryType.expense, description: 'Aluguel', amountCents: 10000, date: DateTime(2026, 8, 5)),
    ];
